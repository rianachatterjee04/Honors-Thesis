...
def process_video(video_path, output_path=None):
    ...
    CONFIDENCE_THRESHOLD = 0.10  # SPEED MODE

    # CSV LOGGING
    csv_filename = os.path.join(OUTPUT_DIR, "speed_mode_results_10.csv")
    ...
    try:
        while True:
            ...
            # Defaults if no objects detected
            object_name = None
            confidence = None
            depth_ft = None
            use_vlm = None
            ...
            csv_writer.writerow([
                ...
                int(use_vlm) if use_vlm is not None else None,
                vlm_text,
                round(latency_ms, 2),
                direction
            ])
