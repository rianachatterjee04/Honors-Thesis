...
def process_video(video_path, output_path=None):
    ...
    CONFIDENCE_THRESHOLD = 0.26 # DESCRIPTIVE MODE, your chosen threshold

    # CSV LOGGING
    csv_filename = os.path.join(OUTPUT_DIR, "balance_mode_results_vlm.csv")
            ...
            if hasattr(results, "boxes") and results.boxes is not None:
                for i, box in enumerate(results.boxes.xyxy):
                    ...
                    # (3) YOLO uncertain → USE VLM
                        ...
                        if encoded:
                            vlm_prompt = """
                            You are assisting a blind user. Analyze this cropped image and provide:
                            1) What the obstacle likely is,
                            2) Whether it is on the left, center, or right of the view,
                            3) A short navigation instruction such as “move left” or “move right.”
