...
def process_video(video_path, output_path=None):
    ...
    CONFIDENCE_THRESHOLD = 0.20 # SPEED MODE, your chosen threshold

    # CSV LOGGING
    csv_filename = os.path.join(OUTPUT_DIR, "speed_mode_results_vlm.csv")
                    ...
                    # (3) YOLO uncertain → USE VLM
                        ...
                        if encoded:
                            vlm_prompt = (
                                ...
                                "Identify the obstacle, say left/center/right, "
                                "and give a short navigation command."
                            )
